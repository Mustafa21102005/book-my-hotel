...
!(function (t, e) {
    ...
    var o =
        ...
        n = {
            version: "0.6.3",
            chart: { fn: e.prototype, internal: { fn: i.prototype } },
        };
    function e(t) {
        ...
        (e.loadConfig(t),
            ...
            (function e(i, n, a) {
                Object.keys(i).forEach(function (t) {
                    ((n[t] = i[t].bind(a)),
                        0 < Object.keys(i[t]).length && e(i[t], n[t], a));
                });
            })(n.chart.fn, this, this));
    }
    function a(t, e, i) {
        ((this.owner = t), (n.chart.internal[e] = i));
    }
    ...
    var r,
        ...
        C = function (t) {
            return !n.chart.internal.fn.isEmpty(t);
        },
        N = function (t, e, i) {
            return k(t[e]) ? t[e] : i;
        },
    ...
    (((s = p.prototype).axisX = function (t, e, i) {
        ...
        (s.generateTicks = function (t) {
            ...
            return (
                0 < n.length && 0 < n[0] && n.unshift(n[0] - (n[1] - n[0])),
                n
            );
        }),
        ...
        (s.updateTickTextCharSize = function (t) {
            var r = this;
            if (r.tickTextCharSize) return r.tickTextCharSize;
            var s = { h: 11.5, w: 5.5 };
            return (
                t
                    .select("text")
                    .text(function (t) {
                        return r.textFormatted(t);
                    })
                    .each(function (t) {
                        var e = this.getBoundingClientRect(),
                            i = r.textFormatted(t),
                            n = e.height,
                            a = i ? e.width / i.length : void 0;
                        n && a && ((s.h = n), (s.w = a));
                    })
                    .text(""),
                (r.tickTextCharSize = s)
            );
        }),
        (s.isVertical = function () {
            return "left" === this.orient || "right" === this.orient;
        }),
        (s.tspanData = function (t, e, i) {
            var n = this,
        ...
        (s.splitTickText = function (t, e) {
            var a,
                r,
                s,
                o = this,
                i = o.textFormatted(t),
                c = o.params.tickWidth;
                ...
                (function t(e, i) {
                    ...
                    for (var n = 1; n < i.length; n++)
                        if (
                            (" " === i.charAt(n) && (r = n),
                            (a = i.substr(0, n + 1)),
                            (s = o.tickTextCharSize.w * a.length),
                            c < s)
                        )
                            return t(
                                e.concat(i.substr(0, r || n)),
                                i.slice(r ? r + 1 : n),
                            );
                    return e.concat(i);
                })([], i + "")
        ...
        (s.ellipsify = function (t, e) {
            if (t.length <= e) return t;
            for (var i = t.slice(0, e), n = 3, a = e - 1; 0 <= a; a--) {
                var r = i[a].length;
                if (
                    ((i[a] = i[a].substr(0, r - n).padEnd(r, ".")),
                    (n -= r) <= 0)
                )
                    break;
            }
                ...
                return (
                    t.each(function () {
                        var t,
                            ...
                            i,
                            n = (A.g = v.select(this)),
                            a = this.__chart__ || w.scale,
                            r = (this.__chart__ = w.copyScale()),
                            s = w.tickValues
                                ? w.tickValues
                                : w.generateTicks(r),
                            o = n.selectAll(".tick").data(s, r),
                            c = o
                                .enter()
                                .insert("g", ".domain")
                                .attr("class", "tick")
                            ...
                            u = o.merge(c);
                        (b.isCategory
                            ? ((w.tickOffset = Math.ceil((r(1) - r(0)) / 2)),
                        ...
                        var l = u.select("line").merge(c.append("line")),
                            h = u.select("text").merge(c.append("text")),
                            g = u
                                .selectAll("text")
                                .selectAll("tspan")
                                .data(function (t, e) {
                                    return w.tspanData(t, e, r);
                                }),
                            f = g
                                .enter()
                                .append("tspan")
                        ...
                        g.exit().remove();
                        var p = n.selectAll(".domain").data([0]),
                            _ = p
                                .enter()
                                .append("path")
                                .merge(p)
                        ...
                        if (r.rangeBand) {
                            ...
                            a.rangeBand ? (a = r) : d.call(t, r, w.tickOffset);
                        (c.call(t, a, w.tickOffset),
                            (S = (m ? u.transition(m) : u)
                                .style("opacity", 1)
                                .call(t, r, w.tickOffset)));
                    }),
                    S
                );
            }
            return (
                ...
                (A.tickInterval = function () {
                    ...
                    return (t = b.isCategory
                        ? 2 * w.tickOffset
                        : (A.g.select("path.domain").node().getTotalLength() -
                              2 * w.outerTickSize) /
    ...
    var x,
        ...
        S = (function (t) {
            function n(t) {
                ...
                return ((i.d3 = t.d3), (i.internal = p), i);
            }
            return (
                (function (t, e) {
    ...
    return (
        ((r = S.prototype).init = function () {
            ...
            ((t.axes.x = i
                ...
                t.axes.x
                    ...
                    .style(
                        "text-anchor",
                        this.textAnchorForXAxisLabel.bind(this),
                    ),
                (t.axes.y = i
                    .append("g")
                ...
                t.axes.y
                    ...
                    .style(
                        "text-anchor",
                        this.textAnchorForYAxisLabel.bind(this),
                    ),
                (t.axes.y2 = i
                    .append("g")
                ...
                t.axes.y2
                    ...
                    .style(
                        "text-anchor",
                        this.textAnchorForY2AxisLabel.bind(this),
                    ));
        }),
        (r.getXAxis = function (t, e, i, n, a, r, s) {
            var o = this.owner,
                c = o.config,
                d = {
            ...
            return (
                ...
                o.isCategorized() &&
                    ...
                    g(c.axis_x_tick_culling) && (c.axis_x_tick_culling = !1)),
                u
            );
        }),
        (r.updateXAxisTickValues = function (t, e) {
            var i,
                n = this.owner,
                a = n.config;
            return (
        ...
        (r.getYAxis = function (t, e, i, n, a, r, s) {
            var o = this.owner,
                c = o.config,
                d = {
                    withOuterTick: a,
                ...
                u = new this.internal(this, d).axis
                    .scale(t)
                    .orient(e)
                    .tickFormat(i);
            return (
        ...
        (r.getLabelPosition = function (t, e) {
        ...
        (r.textForXAxisLabel = function () {
            return this.getLabelText("x");
        }),
        (r.textForYAxisLabel = function () {
            return this.getLabelText("y");
        }),
        (r.textForY2AxisLabel = function () {
            return this.getLabelText("y2");
        }),
        (r.xForAxisLabel = function (t, e) {
            var i = this.owner;
            return t
                ? e.isLeft
                    ? 0
        ...
        (r.textAnchorForAxisLabel = function (t, e) {
            return t
                ? e.isLeft
                    ? "start"
                    : e.isCenter
        ...
        (r.xForXAxisLabel = function () {
            return this.xForAxisLabel(
                !this.owner.config.axis_rotated,
                this.getXAxisLabelPosition(),
            );
        }),
        (r.xForYAxisLabel = function () {
            return this.xForAxisLabel(
                this.owner.config.axis_rotated,
                this.getYAxisLabelPosition(),
            );
        }),
        (r.xForY2AxisLabel = function () {
            return this.xForAxisLabel(
                this.owner.config.axis_rotated,
                this.getY2AxisLabelPosition(),
            );
        }),
        (r.dxForXAxisLabel = function () {
            return this.dxForAxisLabel(
                !this.owner.config.axis_rotated,
                this.getXAxisLabelPosition(),
            );
        }),
        (r.dxForYAxisLabel = function () {
            return this.dxForAxisLabel(
                this.owner.config.axis_rotated,
                this.getYAxisLabelPosition(),
            );
        }),
        (r.dxForY2AxisLabel = function () {
            return this.dxForAxisLabel(
                this.owner.config.axis_rotated,
                this.getY2AxisLabelPosition(),
            );
        }),
        (r.dyForXAxisLabel = function () {
            var t = this.owner,
                e = t.config,
        ...
        (r.textAnchorForXAxisLabel = function () {
            var t = this.owner;
        ...
        (r.textAnchorForYAxisLabel = function () {
            var t = this.owner;
            return this.textAnchorForAxisLabel(
                t.config.axis_rotated,
                this.getYAxisLabelPosition(),
        ...
        (r.textAnchorForY2AxisLabel = function () {
            var t = this.owner;
            return this.textAnchorForAxisLabel(
                t.config.axis_rotated,
                this.getY2AxisLabelPosition(),
        ...
        (r.getMaxTickWidth = function (t, e) {
            var i,
                n,
                a,
                r,
            ...
            return (
                (e && s.currentMaxTickWidths[t]) ||
                    ...
                    (s.currentMaxTickWidths[t] =
                        c <= 0 ? s.currentMaxTickWidths[t] : c)),
                s.currentMaxTickWidths[t]
            );
        }),
        (r.updateLabels = function (t) {
            var e = this.owner,
                i = e.main.select("." + Y.axisX + " ." + Y.axisXLabel),
                n = e.main.select("." + Y.axisY + " ." + Y.axisYLabel),
                a = e.main.select("." + Y.axisY2 + " ." + Y.axisY2Label);
            ((t ? i.transition() : i)
        ...
        (r.convertPixelsToAxisPadding = function (t, e) {
            var i = this.owner;
            return e * (t / (i.config.axis_rotated ? i.width : i.height));
        }),
        (r.generateTickValues = function (t, e, i) {
            var n,
                a,
                r,
                s,
                ...
                u = t;
            if (e)
                if (1 === (n = h(e) ? e() : e)) u = [t[0]];
                else if (2 === n) u = [t[0], t[t.length - 1]];
                else if (2 < n) {
                    for (
                        s = n - 2,
                            a = t[0],
                            o = ((r = t[t.length - 1]) - a) / (s + 1),
                            u = [a],
                            c = 0;
                        c < s;
                        c++
                    )
                        ((d = +a + o * (c + 1)), u.push(i ? new Date(d) : d));
                    u.push(r);
                }
            return (
                i ||
        ...
        (r.generateTransitions = function (t) {
        ...
        (x = n.chart.fn),
        ((m = n.chart.internal.fn).beforeInit = function () {}),
        ...
        (m.initWithData = function (t) {
            ...
            ((n.axis = new S(n)),
                r.bindto
                    ? "function" == typeof r.bindto.node
                        ? (n.selectChart = r.bindto)
                        : (n.selectChart = a.select(r.bindto))
                ...
                r.data_filter &&
                    (n.data.targets = n.data.targets.filter(r.data_filter)),
                r.data_hide &&
                ...
                i
                    ...
                    .attr("class", Y.chart),
                r.grid_lines_front && n.initGridLines(),
                n.initChartElements(),
                n.axis.init(),
        ...
        (m.redraw = function (t, e) {
            ...
            if (
                ...
                (a = N(t, "withTransition", !0)),
                (o = N(t, "withTransform", !1)),
                (c = N(t, "withUpdateXDomain", !1)),
                (d = N(t, "withUpdateOrgXDomain", !1)),
                (u = N(t, "withTrimXDomain", !0)),
                (f = N(t, "withUpdateXAxis", c)),
                (l = N(t, "withLegend", !1)),
                (h = N(t, "withEventRect", !0)),
                (g = N(t, "withDimension", !0)),
                (r = N(t, "withTransitionForExit", a)),
                (s = N(t, "withTransitionForAxis", a)),
                (S = a ? D.transition_duration : 0),
                (w = r ? S : 0),
                (v = s ? S : 0),
                ...
                H.length
                    ? (I.updateXDomain(H, c, d, u),
                      D.axis_x_tick_values ||
                          (C = I.axis.updateXAxisTickValues(H)))
                ...
                if (D.axis_x_tick_culling && C) {
                    ...
                    I.svg
                        .selectAll("." + Y.axisX + " .tick text")
                        .style("display", "block");
            ((p = I.generateDrawArea ? I.generateDrawArea(F, !1) : void 0),
                (_ = I.generateDrawBar ? I.generateDrawBar(X) : void 0),
                (x = I.generateDrawLine ? I.generateDrawLine(M, !1) : void 0),
                (y = I.generateXYForText(F, X, M, !0)),
                (m = I.generateXYForText(F, X, M, !1)),
                I.updateCircleY(),
                ...
                I.redrawArc && I.redrawArc(S, w, o),
                I.redrawSubchart && I.redrawSubchart(n, e, S, w, F, X, M),
                ...
                I.isTabVisible() &&
                    (S
                        ? ((P = k.transition().duration(S)),
                          ...
                          A(function () {
                              (T && T(), D.onrendered && D.onrendered.call(I));
                          }))
                        : (I.redrawBar(_),
                          I.redrawLine(x),
                          I.redrawArea(p),
        ...
        (m.getTranslate = function (t) {
            ...
            return (
                "main" === t
                    ? ((e = l(n.margin.left)), (i = l(n.margin.top)))
                    : "context" === t
                      ? ((e = l(n.margin2.left)), (i = l(n.margin2.top)))
                      : "legend" === t
                        ...
                        : "x" === t
                          ...
                          : "y" === t
                            ...
                            : "y2" === t
                              ? ((e = a.axis_rotated ? 0 : n.width),
                                (i = a.axis_rotated ? 1 : 0))
                              : "subx" === t
                                ? ((e = 0),
                                  (i = a.axis_rotated ? 0 : n.height2))
                                : "arc" === t &&
                                  ((e = n.arcWidth / 2),
                                  (i =
                                      n.arcHeight / 2 -
        ...
        (m.transformMain = function (t, e) {
            ...
            (e && e.axisX
                ? (i = e.axisX)
                : ((i = r.main.select("." + Y.axisX)),
                  t && (i = i.transition())),
                e && e.axisY
                    ? (n = e.axisY)
                    : ((n = r.main.select("." + Y.axisY)),
                      t && (n = n.transition())),
                e && e.axisY2
                    ? (a = e.axisY2)
                    : ((a = r.main.select("." + Y.axisY2)),
                      t && (a = a.transition())),
                (t ? r.main.transition() : r.main).attr(
                    "transform",
                    r.getTranslate("main"),
                ),
                i.attr("transform", r.getTranslate("x")),
                n.attr("transform", r.getTranslate("y")),
                a.attr("transform", r.getTranslate("y2")),
                r.main
                    .select("." + Y.chartArcs)
        ...
        (x.flow = function (t) {
            ...
            ((a = c.convertDataToTargets(e, !0)),
                    ...
                    for (e = 0; e < a.length; e++)
                        if (t.id === a[e].id) {
                            for (
                                ...
                                ((a[e].values[i].index = h + i),
                                    c.isTimeSeries() ||
                                        (a[e].values[i].x = h + i));
                            ((t.values = t.values.concat(a[e].values)),
                                a.splice(e, 1));
                            break;
                        }
                    n || d.push(t.id);
                ...
                c.getMaxDataCount(),
                (r = (n = c.data.targets[0]).values[0]),
                k(t.to)
                    ? ((l = 0),
                      (o = c.isTimeSeries() ? c.parseDate(t.to) : t.to),
                      n.values.forEach(function (t) {
                          t.x < o && l++;
                      }))
                    : k(t.length) && (l = t.length),
                u
                    ? 1 === u &&
                      c.isTimeSeries() &&
                      ((s = (n.values[n.values.length - 1].x - r.x) / 2),
                      (i = [new Date(+r.x - s), new Date(+r.x + s)]),
                      c.updateXDomain(null, !0, !0, !1, i))
                    : ((s = c.isTimeSeries()
                          ? 1 < n.values.length
                              ? n.values[n.values.length - 1].x - r.x
        ...
        (m.generateFlow = function (E) {
            ...
            return function () {
                var t,
                    ...
                    v = h.index,
                    b = h.length,
                    A = O.getValueOnIndex(O.data.targets[0].values, v),
                    T = O.getValueOnIndex(O.data.targets[0].values, v + b),
                    P = O.x.domain(),
                    C = h.duration || w,
                    L = h.done || function () {},
                    V = O.generateWait();
                ((O.flowing = !0),
                    O.data.targets.forEach(function (t) {
                        t.values.splice(0, b);
                    }),
                    (i = O.updateXDomain(l, !0, !0)),
                    O.updateXGrid && O.updateXGrid(!0),
                    (n = O.xgrid || R.selectAll([])),
                    (a = O.xgridLines || R.selectAll([])),
                    (r = O.mainRegion || R.selectAll([])),
                    (s = O.mainText || R.selectAll([])),
                    (o = O.mainBar || R.selectAll([])),
                    (c = O.mainLine || R.selectAll([])),
                    (d = O.mainArea || R.selectAll([])),
                    (u = O.mainCircle || R.selectAll([])),
                    h.orgDataCount
                        ? (t =
                              1 === h.orgDataCount || (A && A.x) === (T && T.x)
                                  ? O.x(P[0]) - O.x(i[0])
                                  : O.isTimeSeries()
                                    ? O.x(P[0]) - O.x(i[0])
                                    : O.x(A.x) - O.x(T.x))
                        : 1 !== O.data.targets[0].values.length
                          ? (t = O.x(P[0]) - O.x(i[0]))
                          : O.isTimeSeries()
                            ? ((A = O.getValueOnIndex(
                                  O.data.targets[0].values,
                                  0,
                              )),
                              (T = O.getValueOnIndex(
                                  O.data.targets[0].values,
                                  O.data.targets[0].values.length - 1,
                              )),
                              (t = O.x(A.x) - O.x(T.x)))
                            : (t = D(i) / 2),
                    (e = "translate(" + t + ",0) scale(" + D(P) / D(i) + ",1)"),
                    O.hideXGridFocus());
                var G = R.transition().ease(R.easeLinear).duration(C);
                (V.add(O.xAxis(O.axes.x, G)),
                    V.add(o.transition(G).attr("transform", e)),
                    V.add(c.transition(G).attr("transform", e)),
                    V.add(d.transition(G).attr("transform", e)),
                    V.add(u.transition(G).attr("transform", e)),
                    V.add(s.transition(G).attr("transform", e)),
                    V.add(
                        r
                            .filter(O.isRegionOnX)
                            .transition(G)
                            .attr("transform", e),
                    ),
                    V.add(n.transition(G).attr("transform", e)),
                    V.add(a.transition(G).attr("transform", e)),
                    V(function () {
                        var t,
                            e = [],
                            i = [];
                        if (b) {
                            ...
                            (O.svg
                                ...
                                O.svg
                                    ...
                                    .selectAll(i)
                                    .remove(),
                                O.svg.select("." + Y.xgrid).remove());
                        }
                        (n
                            .attr("transform", null)
                            .attr("x1", O.xgridAttr.x1)
                            .attr("x2", O.xgridAttr.x2)
                            .attr("y1", O.xgridAttr.y1)
                            .attr("y2", O.xgridAttr.y2)
                            .style("opacity", O.xgridAttr.opacity),
                            a.attr("transform", null),
                            a
                                .select("line")
                                .attr("x1", I.axis_rotated ? 0 : y)
                                .attr("x2", I.axis_rotated ? O.width : y),
                            a
                                .select("text")
                                .attr("x", I.axis_rotated ? O.width : 0)
                                .attr("y", y),
                            o.attr("transform", null).attr("d", g),
                            c.attr("transform", null).attr("d", f),
                            ...
                            s
                                ...
                                .style(
                                    "fill-opacity",
                                    O.opacityForText.bind(O),
                                ),
                            r.attr("transform", null),
                            r
                                .filter(O.isRegionOnX)
                                .attr("x", O.regionX.bind(O))
                                .attr("width", O.regionWidth.bind(O)),
                            L(),
                            (O.flowing = !1));
                    }));
            };
        ...
        (x.focus = function (e) {
            ...
            ((e = i.mapToTargetIds(e)),
                ...
                (i.defocusedTargetIds = i.defocusedTargetIds.filter(
                    function (t) {
                        return e.indexOf(t) < 0;
                    },
                )));
        }),
        (x.defocus = function (e) {
            var t = this.internal;
        ...
        (x.xgrids.add = function (t) {
            var e = this.internal;
            return this.xgrids(e.config.grid_x_lines.concat(t || []));
        }),
        (x.xgrids.remove = function (t) {
        ...
        (x.ygrids.add = function (t) {
            var e = this.internal;
            return this.ygrids(e.config.grid_y_lines.concat(t || []));
        }),
        (x.ygrids.remove = function (t) {
        ...
        (x.load = function (e) {
            var t = this.internal,
                i = t.config;
            (e.xs && t.addXs(e.xs),
                "names" in e && x.data.names.bind(this)(e.names),
                "classes" in e &&
        ...
        (x.regions = function (t) {
            var e = this.internal,
                i = e.config;
            return (
                t && ((i.regions = t), e.redrawWithoutRescale()),
                i.regions
            );
        }),
        (x.regions.add = function (t) {
            var e = this.internal,
                i = e.config;
            return (
                t &&
        ...
        (x.regions.remove = function (t) {
            ...
            return (
                (t = t || {}),
                (e = a.getOption(t, "duration", r.transition_duration)),
                (i = a.getOption(t, "classes", [Y.region])),
                (n = a.main.select("." + Y.regions).selectAll(
                    i.map(function (t) {
                        return "." + t;
                    }),
                )),
                (e ? n.transition().duration(e) : n)
                    .style("opacity", 0)
                    .remove(),
                (r.regions = r.regions.filter(function (t) {
                    var e = !1;
                    return (
                        !t.class ||
                ...
                l.main
                    ...
                    .each(function (t, e) {
                        var i = h.select(this),
                            ...
                            a = l.getToggle(this, t).bind(l),
                            r =
                                g.data_selection_grouped ||
                                !c ||
                                0 <= c.indexOf(n),
                            s = !d || 0 <= d.indexOf(e),
                            o = i.classed(Y.SELECTED);
                        i.classed(Y.line) ||
                            i.classed(Y.area) ||
                            (r && s
                                ? g.data_selection_isselectable(t) &&
                                  !o &&
                                  a(!0, i.classed(Y.SELECTED, !0), t, e)
                                : k(u) &&
                                  u &&
                                  o &&
                                  a(!1, i.classed(Y.SELECTED, !1), t, e));
                    });
        }),
        (x.unselect = function (c, d) {
            var u = this.internal,
                l = u.d3,
                h = u.config;
        ...
        (x.tooltip.hide = function () {
            (this.internal.dispatchEvent("mouseout", 0),
                this.internal.config.tooltip_onhide.call(this));
        }),
        (x.transform = function (t, e) {
            var i = this.internal,
                n =
        ...
        (m.updateAngle = function (e) {
            ...
            return s
                ? (r
                      .pie(r.filterTargetsToShow(r.data.targets))
                      .forEach(function (t) {
                          (o ||
                              t.data.id !== e.data.id ||
                              ((o = !0), ((e = t).index = c)),
                  ...
                  r.isGaugeType(e.data) &&
                      ((t = s.gauge_min),
                      (i = s.gauge_max),
                      (n = (Math.PI * (s.gauge_fullCircle ? 2 : 1)) / (i - t)),
                      (a = e.value < t ? 0 : e.value < i ? e.value - t : i - t),
                      (e.startAngle = s.gauge_startingAngle),
                      (e.endAngle = e.startAngle + n * a)),
                  o ? e : null)
                : null;
        }),
        (m.getSvgArc = function () {
            var n = this,
                ...
                t = function (t, e) {
                    var i;
                    return e ? a(t) : (i = n.updateAngle(t)) ? a(i) : "M 0 0";
                };
            return ((t.centroid = a.centroid), t);
        }),
        (m.getSvgArcExpanded = function (e) {
            e = e || 1;
            var i = this,
                n = i.hasType("gauge"),
                a =
                ...
                s = i.d3
                    ...
                    .outerRadius(function (t) {
                        return n
                            ? i.radius - a * t.index + r
                            : i.radiusExpanded * e;
                    })
                    .innerRadius(function (t) {
                        return n ? i.radius - a * (t.index + 1) : i.innerRadius;
                    });
            return function (t) {
            ...
            if (c && !u)
                ((e = this.svgArc.centroid(c)),
                    ...
                    (d =
                        ...
                        i *
                            (r =
                                s.hasType("donut") && o.donut_label_ratio
                                    ? h(o.donut_label_ratio)
                                        ? o.donut_label_ratio(t, s.radius, a)
                                        : o.donut_label_ratio
                                    : s.hasType("pie") && o.pie_label_ratio
                                      ? h(o.pie_label_ratio)
                                          ? o.pie_label_ratio(t, s.radius, a)
                                          : o.pie_label_ratio
                                      : s.radius && a
                                        ? ((0.375 < 36 / s.radius
                                              ? 1.175 - 36 / s.radius
                ...
                c &&
                u &&
                1 < s.filterTargetsToShow(s.data.targets).length
            ) {
                var l = Math.sin(c.endAngle - Math.PI / 2);
                d =
                    "translate(" +
                    (i =
                        ...
                        (s.radiusExpanded + 25)) +
                    "," +
                    (n = l * (s.radiusExpanded + 15 - Math.abs(10 * l)) + 3) +
                    ")";
            }
            return d;
        }),
        ...
        (m.redrawArc = function (t, e, i) {
            ...
            if (
                ((a = (n = d
                    .selectAll("." + Y.arcs)
                    .selectAll("." + Y.arc)
                    .data(u.arcData.bind(u)))
                    .enter()
                    .append("path")
                    .attr("class", u.classArc.bind(u))
                    .style("fill", function (t) {
                        return u.color(t.data);
                    })
                    .style("cursor", function (t) {
                        return c.interaction_enabled &&
                            c.data_selection_isselectable(t)
                            ? "pointer"
                            : null;
                    })
                    .each(function (t) {
                        (u.isGaugeType(t.data) &&
                            (t.startAngle = t.endAngle = c.gauge_startingAngle),
                            (this._current = t));
                    })
                    .merge(n)),
                h &&
                    ((o = (s = d
                        ...
                        .merge(s)),
                    1 === u.filterTargetsToShow(u.data.targets).length
                        ? o.style("display", "none")
                        : o
                              .style("fill", function (t) {
                                  return 0 < c.color_pattern.length
                                      ? u.levelColor(t.data.values[0].value)
                                      : u.color(t.data);
                              })
                              .style(
                                  "display",
                                  c.gauge_labelLine_show ? "" : "none",
                              )
                              .each(function (t) {
                                  var e = 0,
                                      i = 0,
                                      ...
                                      a = "";
                                  if (
                                      u.hiddenTargetIds.indexOf(t.data.id) < 0
                                  ) {
                                      var r = u.updateAngle(t),
                                          s =
                                              (u.gaugeArcWidth /
                                                  u.filterTargetsToShow(
                                                      u.data.targets,
                                                  ).length) *
                                              (r.index + 1),
                ...
                a
                    .attr("transform", function (t) {
                        return !u.isGaugeType(t.data) && i ? "scale(0)" : "";
                    })
                    .on(
                        "mouseover",
                        c.interaction_enabled
                            ? function (t) {
                                  var e, i;
                                  u.transiting ||
                                      ((e = u.updateAngle(t)) &&
                                          ((i = u.convertToArcData(e)),
                                          u.expandArc(e.data.id),
                                          u.api.focus(e.data.id),
                                          u.toggleFocusLegend(e.data.id, !0),
                                          u.config.data_onmouseover(i, this)));
                              }
                            : null,
                    )
                    .on(
                        ...
                        c.interaction_enabled
                            ? function (t) {
                                  var e,
                                      i = u.updateAngle(t);
                                  i &&
                                      ((e = [u.convertToArcData(i)]),
                                      u.showTooltip(e, this));
                              }
                            : null,
                    )
                    .on(
                        ...
                        c.interaction_enabled
                            ? function (t) {
                                  ...
                                  u.transiting ||
                                      ((e = u.updateAngle(t)) &&
                                          ((i = u.convertToArcData(e)),
                                          u.unexpandArc(e.data.id),
                                          u.api.revert(),
                                          u.revertLegend(),
                                          u.hideTooltip(),
                                          u.config.data_onmouseout(i, this)));
                              }
                            : null,
                    )
                    .on(
                        ...
                        c.interaction_enabled
                            ? function (t, e) {
                                  var i,
                                      n = u.updateAngle(t);
                                  n &&
                                      ((i = u.convertToArcData(n)),
                                      u.toggleShape &&
                                          u.toggleShape(this, i, e),
                                      u.config.data_onclick.call(
                                          u.api,
                                          i,
                                          this,
                                      ));
                    ...
                    .attrTween("d", function (i) {
                        ...
                        return t
                            ? (isNaN(this._current.startAngle) &&
                              ...
                              (n = l.interpolate(this._current, t)),
                              (this._current = n(0)),
                              function (t) {
                                  var e = n(t);
                                  return ((e.data = i.data), u.getArc(e, !0));
                              })
                            : function () {
                                  return "M 0 0";
                              };
                ...
                d
                    ...
                    .style("opacity", 0)
                    .attr("class", function (t) {
                        return u.isGaugeType(t.data) ? Y.gaugeValue : "";
                    })
                    .text(u.textForArcLabel.bind(u))
                    .attr("transform", u.transformForArcLabel.bind(u))
                    .style("font-size", function (t) {
                        return u.isGaugeType(t.data) &&
                            1 === u.filterTargetsToShow(u.data.targets).length
                            ? Math.round(u.radius / 5) + "px"
                            : "";
                    })
                    .transition()
                    .duration(t)
                    .style("opacity", function (t) {
                        return u.isTargetToShow(t.data.id) &&
                            u.isArcType(t.data)
                            ? 1
                            : 0;
                    }),
                d
                    ...
                    .style("opacity", u.hasType("donut") || h ? 1 : 0),
                h)
            ) {
                var g = 0;
                ((r = u.arcs
                    ...
                    .attr("d", function (t) {
                        if (0 <= u.hiddenTargetIds.indexOf(t.id))
                            return "M 0 0";
                        var e = {
                            ...
                            endAngle:
                                -1 *
                                c.gauge_startingAngle *
                                (c.gauge_fullCircle ? Math.PI : 1),
                            index: g++,
                        };
                        return u.getArc(e, !0, !0);
                    }),
                    r.exit().remove(),
                    u.arcs
                        .select("." + Y.chartArcsGaugeUnit)
                        .attr("dy", ".75em")
                        .text(c.gauge_label_show ? c.gauge_units : ""),
                    u.arcs
                        ...
                        .attr(
                            ...
                            -1 *
                                (u.innerRadius +
                                    (u.radius - u.innerRadius) /
                                        (c.gauge_fullCircle ? 1 : 2)) +
                                "px",
                        )
                        .attr("dy", "1.2em")
                        .text(
                            c.gauge_label_show
                                ? u.textForGaugeMinMax(c.gauge_min, !1)
                                : "",
                        ),
                    u.arcs
                        ...
                        .text(
                            c.gauge_label_show
                                ? u.textForGaugeMinMax(c.gauge_max, !0)
                                : "",
                        ));
            }
        }),
        ...
        (m.generateTargetClass = function (t) {
        ...
        (m.generateColor = function () {
            var t = this.config,
                e = this.d3,
                n = t.data_colors,
                a = C(t.color_pattern) ? t.color_pattern : e.schemeCategory10,
                r = t.data_color,
                s = [];
            return function (t) {
                var e,
        ...
        (m.generateLevelColor = function () {
            var t = this.config,
                ...
                e = t.color_threshold,
                a = "value" === e.unit,
                r = e.values && e.values.length ? e.values : [],
                s = e.max || 100;
        ...
        (m.convertUrlToData = function (t, e, i, n, a) {
            var r,
                s,
                o = this,
                c = e || "csv";
            ("json" === c
                ...
                : ((r = "tsv" === c ? o.d3.tsv : o.d3.csv),
                  (s = o.convertXsvToData)),
                r(t, i)
                    .then(function (t) {
        ...
        (m.convertJsonToData = function (e, t) {
            ...
            return (
                t
                    ? (t.x
                          ? ((a = t.value.concat(t.x)), (r.config.data_x = t.x))
                          : (a = t.value),
                      s.push(a),
                      e.forEach(function (i) {
                          var n = [];
                          (a.forEach(function (t) {
                              var e = r.findValueInJson(i, t);
                              (v(e) && (e = null), n.push(e));
                          }),
                              s.push(n));
                      }),
                      (i = r.convertRowsToData(s)))
                    : (Object.keys(e).forEach(function (t) {
                          s.push([t].concat(e[t]));
                      }),
                      (i = r.convertColumnsToData(s))),
                i
            );
        }),
        ...
        (m.convertDataToTargets = function (t, n) {
            var e,
                i,
                a,
                r,
                ...
                d = c.config;
            return (
                u(t) ? (r = Object.keys(t[0])) : ((r = t.keys), (t = t.rows)),
                (i = r.filter(c.isNotX, c)),
                (a = r.filter(c.isX, c)),
                ...
                (e = i.map(function (r, s) {
                    var o = d.data_idConverter(r);
                    return {
                        id: o,
                        id_org: r,
                        values: t
                            .map(function (t, e) {
                                ...
                                return (
                                    c.isCustomX() && c.isCategorized() && !v(n)
                                        ...
                                        : (i = c.generateTargetX(n, r, e)),
                                    (v(t[r]) || c.data.xs[r].length <= e) &&
                                        (i = void 0),
                                    { x: i, value: a, id: o }
                                );
                            })
        ...
        (m.updateTargetX = function (t, n) {
            var a = this;
            t.forEach(function (i) {
                (i.values.forEach(function (t, e) {
                    t.x = a.generateTargetX(n[e], i.id, e);
                }),
                    (a.data.xs[i.id] = n));
            });
        }),
        ...
        (m.generateTargetX = function (t, e, i) {
            var n = this;
        ...
        (m.hasDataLabel = function () {
            ...
            return (
                ...
                !("object" !== o(t.data_labels) || !C(t.data_labels))
            );
        }),
        (m.getDataLabelLength = function (t, e, i) {
            var n = this,
                a = [0, 0];
            return (
                n.selectChart
            ...
            (i &&
                ...
                (n.type || n.types) &&
                    i.forEach(function (t) {
                        ...
                        a.setTargetType(t.id, e);
                    }),
                a.data.targets.forEach(function (t) {
                    for (var e = 0; e < i.length; e++)
                        if (t.id === i[e].id) {
                ...
                (a.data.targets = a.data.targets.concat(i))),
                          ...
                          ((i.withoutFadeIn[e] = !1),
                              i.legend &&
                                  i.legend
                                      ...
                                      .remove(),
                              (i.data.targets = i.data.targets.filter(
                                  function (t) {
                                      return t.id !== e;
                                  },
                              )));
        ...
        (m.getYDomain = function (t, e, i) {
            var n,
                ...
                _ = i ? g.filterByXDomain(p, i) : p,
                x = "y2" === e ? f.axis_y2_min : f.axis_y_min,
                y = "y2" === e ? f.axis_y2_max : f.axis_y_max,
                m = g.getYDomainMin(_),
                S = g.getYDomainMax(_),
                w = "y2" === e ? f.axis_y2_center : f.axis_y_center,
                v =
                    (g.hasType("bar", _) && f.bar_zerobased) ||
                    (g.hasType("area", _) && f.area_zerobased),
                b = "y2" === e ? f.axis_y2_inverted : f.axis_y_inverted,
                A = g.hasDataLabel() && f.axis_rotated,
                T = g.hasDataLabel() && !f.axis_rotated;
            return (
                ...
                0 === _.length
                    ...
                    : (isNaN(m) && (m = 0),
                      ...
                      ((P(x) && l) || (P(y) && h)) && (v = !1),
                      v && (l && (m = 0), h && (S = 0)),
                      (r = s = 0.1 * (a = Math.abs(S - m))),
                      void 0 !== w &&
                          ((S = w + (o = Math.max(Math.abs(m), Math.abs(S)))),
                          (m = w - o)),
                      A
                          ...
                          : T &&
                            ...
                            (r += g.axis.convertPixelsToAxisPadding(c[1], a)),
                            (s += g.axis.convertPixelsToAxisPadding(c[0], a))),
                      "y" === e &&
                          C(f.axis_y_padding) &&
                          ((r = g.axis.getPadding(
                              f.axis_y_padding,
                ...
                (i = this.isCategorized()
                    ...
                    : this.hasType("bar")
                      ? 1 < (e = this.getMaxDataCount())
                          ...
                          : 0.5
                      : 0.01 * s),
                "object" === o(r.axis_x_padding) && C(r.axis_x_padding)
                    ? ((n = P(r.axis_x_padding.left)
                          ? r.axis_x_padding.left
                          : i),
                      (a = P(r.axis_x_padding.right)
                          ? r.axis_x_padding.right
                          : i))
                    : (n = a =
                          "number" == typeof r.axis_x_padding
                              ? r.axis_x_padding
                              : i),
                { left: n, right: a }
            );
        ...
        (m.updateXDomain = function (t, e, i, n, a) {
            var r = this,
                s = r.config;
            return (
                i &&
        ...
        (m.drag = function (t) {
            ...
            _.hasArcType() ||
                (r.data_selection_enabled &&
                    ...
                    (h = Math.min(e, n)),
                    (g = Math.max(e, n)),
                    (f = r.data_selection_grouped
                        ? _.margin.top
                        : Math.min(i, a)),
                    (p = r.data_selection_grouped ? _.height : Math.max(i, a)),
                    s
                        .select("." + Y.dragarea)
                        .attr("x", h)
                        .attr("y", f)
                    ...
                    s
                        ...
                        .selectAll("." + Y.shape)
                        .filter(function (t) {
                            return r.data_selection_isselectable(t);
                        })
                        .each(function (t, e) {
                            var i,
                                n,
        ...
        (m.getYFormat = function (t) {
            ...
            return function (t, e, i) {
                return ("y2" === n.axis.getId(i) ? r : a).call(n, t, e);
            };
        }),
        ...
        (m.updateYGrid = function () {
            var t = this,
                ...
                n = t.main
                    ...
                    .selectAll("." + Y.ygrid)
                    .data(i),
                a = n.enter().append("line").attr("class", Y.ygrid);
            ((t.ygrid = a.merge(n)),
                t.ygrid
        ...
        (m.updateGrid = function (t) {
            var e,
                ...
                c = r.xv.bind(r),
                d = r.yv.bind(r),
                u = r.xGridTextX.bind(r),
                l = r.yGridTextX.bind(r);
            (r.grid.style("visibility", r.hasArcType() ? "hidden" : "visible"),
                s.select("line." + Y.xgridFocus).style("visibility", "hidden"),
                ...
                (i = (e = s
                    ...
                    .append("line")
                    .attr("x1", o.axis_rotated ? 0 : c)
                    .attr("x2", o.axis_rotated ? r.width : c)
                    .attr("y1", o.axis_rotated ? c : 0)
                    .attr("y2", o.axis_rotated ? c : r.height)
                    .style("opacity", 0),
                i
                    .append("text")
                    .attr("text-anchor", r.gridTextAnchor)
                    .attr("transform", o.axis_rotated ? "" : "rotate(-90)")
                    .attr("x", o.axis_rotated ? l : u)
                    .attr("y", c)
                    .attr("dx", r.gridTextDx)
                    .attr("dy", -5)
                    .style("opacity", 0),
                (r.xgridLines = i.merge(e)),
                ...
                (a = (n = s
                    ...
                    .append("line")
                    .attr("x1", o.axis_rotated ? d : 0)
                    .attr("x2", o.axis_rotated ? d : r.width)
                    .attr("y1", o.axis_rotated ? 0 : d)
                    .attr("y2", o.axis_rotated ? r.height : d)
                    .style("opacity", 0),
                a
                    .append("text")
                    .attr("text-anchor", r.gridTextAnchor)
                    .attr("transform", o.axis_rotated ? "rotate(-90)" : "")
                    .attr("x", o.axis_rotated ? u : l)
                    .attr("y", d)
                    .attr("dx", r.gridTextDx)
                    .attr("dy", -5)
                    .style("opacity", 0),
                (r.ygridLines = a.merge(n)),
                r.ygridLines
                    .select("line")
                    .transition()
                    .duration(t)
        ...
        (m.showXGridFocus = function (t) {
            var e = this,
                ...
                a = e.main.selectAll("line." + Y.xgridFocus),
                r = e.xx.bind(e);
            i.tooltip_show &&
                (e.hasType("scatter") ||
                    e.hasArcType() ||
                    (a
                        ...
                        .data([n[0]])
                        .attr(i.axis_rotated ? "y1" : "x1", r)
                        .attr(i.axis_rotated ? "y2" : "x2", r),
        ...
        (m.generateGridData = function (t, e) {
            ...
            if ("year" === t)
                for (
                    ...
                    s.push(new Date(r + "-01-01 00:00:00"));
            else
                (s = e.ticks(10)).length > o &&
        ...
        (m.removeGridLines = function (t, e) {
            var i = this.config,
                ...
                r = e ? Y.xgridLines : Y.ygridLines,
                s = e ? Y.xgridLine : Y.ygridLine;
            (this.main
                .select("." + r)
                .selectAll("." + s)
                .filter(n)
                ...
                .remove(),
                e
                    ? (i.grid_x_lines = i.grid_x_lines.filter(a))
                    : (i.grid_y_lines = i.grid_y_lines.filter(a)));
        }),
        ...
        (m.redrawEventRect = function () {
            var t,
                ...
                s = a.config;
            function o() {
                (a.svg.select("." + Y.eventRect).style("cursor", null),
                    a.hideXGridFocus(),
                    a.hideTooltip(),
                    a.unexpandCircles(),
                    a.unexpandBars());
                    ...
                    .on(
                        ...
                        s.interaction_enabled
                            ? function () {
                                  ...
                                  a.dragging ||
                                      a.hasArcType(t) ||
                                      ((t = a.filterTargetsToShow(
                                          a.data.targets,
                                      )),
                                      (e = r.mouse(this)),
                                      (i = a.findClosestFromTargets(t, e)),
                                      !a.mouseover ||
                                          (i && i.id === a.mouseover.id) ||
                                          (s.data_onmouseout.call(
                                              a.api,
                                              a.mouseover,
                                          ),
                                          (a.mouseover = void 0)),
        ...
        (m.getMousePosition = function (t) {
            return [this.x(t.x), this.getYScale(t.id)(t.value)];
        }),
        (m.dispatchEvent = function (t, e) {
            var i = "." + Y.eventRect,
        ...
        (m.updateLegend = function (p, t, e) {
            ...
            function R(t, e, i) {
                var n,
                    ...
                    u =
                        ...
                        S.legend_padding,
                    l = d.height + w,
                    h = m.isLegendRight || m.isLegendInset ? l : u,
                    g =
                ...
                (o && (A = b = I = C = 0),
                    !S.legend_show || m.isLegendToShow(e)
                        ? ((V[e] = u),
                          ...
                          (!b || b <= u) && (b = u),
                          (!A || A <= l) && (A = l),
                          (a = m.isLegendRight || m.isLegendInset ? A : b),
                          S.legend_equally
            ...
            ((p = p.filter(function (t) {
                ...
                m.isLegendInset &&
                    ((I = S.legend_inset_step ? S.legend_inset_step : p.length),
                ...
                l
                    ...
                    .attr("y1", m.isLegendRight || m.isLegendInset ? -200 : u)
                    .attr("x2", m.isLegendRight || m.isLegendInset ? d : -200)
                    .attr("y2", m.isLegendRight || m.isLegendInset ? -200 : u)
                ...
                (h ? f.transition() : f).attr("x", n).attr("y", s),
                (_ = m.legend.selectAll("rect." + Y.legendItemEvent).data(p)),
                (h ? _.transition() : _)
                    ...
                    .attr("x", a)
                    .attr("y", o),
                (x = m.legend.selectAll("line." + Y.legendItemTile).data(p)),
                (h ? x.transition() : x)
                    .style(
                        "stroke",
                        m.levelColor
        ...
        (m.updateRegion = function (t) {
            ...
            var n = e.main
                ...
                a = n
                    ...
                    .style("fill-opacity", 0);
            ((e.mainRegion = a.merge(n).attr("class", e.classRegion.bind(e))),
                n.exit().transition().duration(t).style("opacity", 0).remove());
        }),
        (m.redrawRegion = function (t, e) {
            var i = this,
                n = i.mainRegion;
            return [
                (t ? n.transition(e) : n)
        ...
        (m.selectPoint = function (t, e, i) {
            var n = this,
                a = n.config,
                r = (a.axis_rotated ? n.circleY : n.circleX).bind(n),
                s = (a.axis_rotated ? n.circleX : n.circleY).bind(n),
                o = n.pointSelectR.bind(n);
        ...
        (m.unselectPoint = function (t, e, i) {
        ...
        (m.togglePoint = function (t, e, i, n) {
        ...
        (m.toggleShape = function (t, e, i) {
            var n = this,
                a = n.d3,
                r = n.config,
                s = a.select(t),
                o = s.classed(Y.SELECTED),
                c = n.getToggle(t, e).bind(n);
            r.data_selection_enabled &&
                r.data_selection_isselectable(e) &&
                (r.data_selection_multiple ||
                    n.main
                        .selectAll(
                            "." +
        ...
        (m.updateBar = function (t) {
            var e = this,
                ...
                o = s
                    ...
                    .style("stroke", r)
                    .style("fill", r);
            ((e.mainBar = o.merge(s).style("opacity", a)),
                s.exit().transition().duration(t).style("opacity", 0));
        }),
        (m.redrawBar = function (t, e, i) {
            return [
        ...
        (m.generateDrawBar = function (t, e) {
            var r = this.config,
                s = this.generateGetBarPoints(t, e);
            return function (t, e) {
                var i = s(t, e),
                    n = r.axis_rotated ? 1 : 0,
                    a = r.axis_rotated ? 0 : 1;
                return (
                    "M " +
                    i[0][n] +
                    "," +
        ...
        (m.generateGetBarPoints = function (t, e) {
            var s = this,
                i = e ? s.subXAxis : s.xAxis,
                n = t.__max__ + 1,
                o = s.getBarW(i, n),
                c = s.getShapeX(o, n, t, !!e),
                d = s.getShapeY(!!e),
                u = s.getShapeOffset(s.isBarType, t, !!e),
                l = o * (s.config.bar_space / 2),
                h = e ? s.getSubYScale : s.getYScale;
            return function (t, e) {
                var i = h.call(s, t.id)(0),
                    n = u(t, e) || i,
                    a = c(t),
                    r = d(t);
                return (
                    s.config.axis_rotated &&
                        ((0 < t.value && r < i) || (t.value < 0 && i < r)) &&
                        (r = i),
                    [
                        [a + l, n],
                        [a + l, r - (i - n)],
        ...
        (m.getShapeX = function (i, n, a, t) {
            var r = t ? this.subX : this.x;
            return function (t) {
                var e = t.id in a ? a[t.id] : 0;
                return t.x || 0 === t.x ? r(t.x) - i * (n / 2 - e) : 0;
            };
        }),
        ...
        (m.getShapeOffset = function (t, o, e) {
            var c = this,
                d = c.orderTargets(
            ...
            return function (i, n) {
                var a = e ? c.getSubYScale(i.id) : c.getYScale(i.id),
                    r = a(0),
                    s = r;
                return (
        ...
        (m.generateDrawLine = function (t, o) {
            var c = this,
                d = c.config,
                u = c.d3.line(),
                i = c.generateGetLinePoints(t, o),
                l = o ? c.getSubYScale : c.getYScale,
                e = function (t) {
                    return (o ? c.subxx : c.xx).call(c, t);
                },
                n = function (t, e) {
                    return 0 < d.data_groups.length
                        ? i(t, e)[0][1]
                        : l.call(c, t.id)(t.value);
                };
            return (
                (u = d.axis_rotated ? u.x(n).y(e) : u.x(e).y(n)),
                d.line_connectNull ||
                    (u = u.defined(function (t) {
                        return null != t.value;
                    })),
                function (t) {
                    var e,
                        i = d.line_connectNull
                            ? c.filterRemoveNull(t.values)
                            : t.values,
                        n = o ? c.subX : c.x,
                        a = l.call(c, t.id),
                        r = 0,
                    ...
                    return (
                        c.isLineType(t)
                            ? d.data_regions[t.id]
                                ...
                                : (c.isStepType(t) &&
                                      (i = c.convertValuesToStep(i)),
                                  (e = u.curve(c.getInterpolate(t))(i)))
                            : (i[0] && ((r = n(i[0].x)), (s = a(i[0].value))),
                              (e = d.axis_rotated
                                  ? "M " + s + " " + r
                                  : "M " + r + " " + s)),
                        e || "M 0 0"
        ...
        (m.generateGetLinePoints = function (t, e) {
            var s = this,
                o = s.config,
                i = t.__max__ + 1,
                c = s.getShapeX(0, i, t, !!e),
                d = s.getShapeY(!!e),
                u = s.getShapeOffset(s.isLineType, t, !!e),
                l = e ? s.getSubYScale : s.getYScale;
            return function (t, e) {
                var i = l.call(s, t.id)(0),
                    n = u(t, e) || i,
                    a = c(t),
                    r = d(t);
                return (
        ...
        (m.lineWithRegions = function (t, c, d, e) {
            var i,
                n,
                a,
                r,
            ...
            if (k(e))
                for (i = 0; i < e.length; i++)
                    ((m[i] = {}),
                        v(e[i].start)
                            ? (m[i].start = t[0].x)
                            : (m[i].start = p.isTimeSeries()
                                  ? p.parseDate(e[i].start)
                                  : e[i].start),
                        v(e[i].end)
                            ? (m[i].end = t[t.length - 1].x)
                            : (m[i].end = p.isTimeSeries()
                                  ? p.parseDate(e[i].end)
                                  : e[i].end));
            function w(t) {
                return (
            ...
            for (
                ...
                if (v(m) || !S(t[i].x, m)) x += " " + g(t[i]) + " " + f(t[i]);
                else
                    for (
                        r = p.getScale(
                            t[i - 1].x + y,
                            ...
                            u = p.getScale(t[i - 1].value, t[i].value),
                            s = c(t[i].x) - c(t[i - 1].x),
                            o = d(t[i].value) - d(t[i - 1].value),
                            h =
                                2 *
                                (l =
                                    2 /
                                    Math.sqrt(Math.pow(s, 2) + Math.pow(o, 2))),
                            n = l;
                        n <= 1;
                        n += h
                    )
        ...
        (m.updateArea = function (t) {
            ...
            ((e.mainArea = a.merge(n).style("opacity", e.orgAreaOpacity)),
                n.exit().transition().duration(t).style("opacity", 0));
        }),
        (m.redrawArea = function (t, e, i) {
            return [
            ...
            return (
                ...
                function (t) {
                    ...
                    return (
                        r.isAreaType(t)
                            ? (r.isStepType(t) &&
                                  (i = r.convertValuesToStep(i)),
                              (e = o.curve(r.getInterpolate(t))(i)))
                            : (i[0] &&
                                  ((n = r.x(i[0].x)),
                                  (a = r.getYScale(t.id)(i[0].value))),
                              (e = s.axis_rotated
                                  ? "M " + a + " " + n
                                  : "M " + n + " " + a)),
                        e || "M 0 0"
        ...
        (m.generateGetAreaPoints = function (t, e) {
            var s = this,
                ...
                c = s.getShapeX(0, i, t, !!e),
                d = s.getShapeY(!!e),
                u = s.getShapeOffset(s.isAreaType, t, !!e),
                l = e ? s.getSubYScale : s.getYScale;
            return function (t, e) {
                var i = l.call(s, t.id)(0),
                    n = u(t, e) || i,
        ...
        (m.redrawCircle = function (t, e, i, n) {
            var a = this,
                r = a.main.selectAll("." + Y.selectedCircle);
            return [
                (i ? a.mainCircle.transition(n) : a.mainCircle)
                    .style("opacity", this.opacityForCircle.bind(a))
                    .style("fill", a.color)
                    .attr("cx", t)
                    .attr("cy", e),
                (i ? r.transition(n) : r).attr("cx", t).attr("cy", e),
            ];
        }),
        ...
        (m.expandCircles = function (t, e, i) {
            ...
            return P(e.padding_left)
                ...
                : e.axis_rotated
                  ? !e.axis_x_show || e.axis_x_inner
                      ? 1
                      : Math.max(d(this.getAxisWidthByAxisId("x", t)), 40)
                  : !e.axis_y_show || e.axis_y_inner
                    ? this.axis.getYAxisLabelPosition().isOuter
                        ? 30
                        : 1
                    : d(this.getAxisWidthByAxisId("y", t));
        }),
        ...
        (m.getSvgLeft = function (t) {
            var e = this,
                ...
                a = i.axis_rotated ? Y.axisX : Y.axisY,
                r = e.main.select("." + a).node(),
                s = r && n ? r.getBoundingClientRect() : { right: 0 },
        ...
        (m.initBrush = function (t) {
            var a = this,
                e = a.d3;
            return (
                (a.brush = (a.config.axis_rotated ? e.brushY() : e.brushX())
                    .on("brush", function () {
                        var t = e.event.sourceEvent;
                        (t && "zoom" === t.type) || a.redrawForBrush();
                    })
                    .on("end", function () {
                        var t = e.event.sourceEvent;
                        (t && "zoom" === t.type) ||
                ...
                (a.brush.updateExtent = function () {
                    var t,
                        e = this.scale.range();
                    return (
                        (t = a.config.axis_rotated
                            ? [
                                  [0, e[0]],
                                  [a.width2, e[1]],
                              ]
                ...
                (a.brush.updateScale = function (t) {
                    return ((this.scale = t), this);
                }),
                (a.brush.update = function (t) {
                    (this.updateScale(t || a.subX).updateExtent(),
                        a.context.select("." + Y.brush).call(this));
                }),
                (a.brush.clear = function () {
                    a.context.select("." + Y.brush).call(a.brush.move, null);
                }),
                (a.brush.selection = function () {
                    return e.brushSelection(
                        a.context.select("." + Y.brush).node(),
                    );
                }),
                (a.brush.selectionAsValue = function (t, e) {
                    var i, n;
                    return t
                        ? (a.context &&
                              ((i = [this.scale(t[0]), this.scale(t[1])]),
                              (n = a.context.select("." + Y.brush)),
                              e && (n = n.transition()),
                              a.brush.move(n, i)),
                          [])
                        : ((i = a.brush.selection() || [0, 0]),
                          [this.scale.invert(i[0]), this.scale.invert(i[1])]);
                }),
                (a.brush.empty = function () {
                    var t = a.brush.selection();
                    return !t || t[0] === t[1];
                }),
                a.brush.updateScale(t)
            );
        }),
        ...
        (m.updateTargetsForSubchart = function (t) {
            var e,
                ...
                u = r.classChartLine.bind(r),
                l = r.classLines.bind(r),
            ...
            o.subchart_show &&
                ...
                s
                    ...
                    .attr(
                        o.axis_rotated ? "width" : "height",
                        o.axis_rotated ? r.width2 : r.height2,
                    ));
        }),
        ...
        (m.redrawBarForSubchart = function (t, e, i) {
            (e
                ? this.contextBar
        ...
        (m.redrawLineForSubchart = function (t, e, i) {
            (e
                ? this.contextLine
                      .transition(Math.random().toString())
                      .duration(i)
        ...
        (m.updateAreaForSubchart = function (t) {
            ...
            (n.exit().transition().duration(t).style("opacity", 0).remove(),
                (e.contextArea = a.merge(n).style("opacity", 0)));
        }),
        (m.redrawAreaForSubchart = function (t, e, i) {
            (e
                ? this.contextArea
                      .transition(Math.random().toString())
                      .duration(i)
        ...
        (m.redrawSubchart = function (t, e, i, n, a, r, s) {
            var o,
                c,
                d,
                u = this,
        ...
        (m.getDefaultSelection = function () {
            var t = this,
                e = t.config,
        ...
        (m.updateTargetsForText = function (t) {
            var e = this,
                ...
                s = r
                    ...
                    .style("opacity", 0)
                    .style("pointer-events", "none");
            (s.append("g").attr("class", n),
                s.merge(r).attr("class", function (t) {
                    return i(t) + a(t);
                }));
        }),
        (m.updateText = function (t, e, i) {
            var n = this,
                a = n.config,
                r = n.barOrLineData.bind(n),
                s = n.classText.bind(n),
                o = n.main
                    .selectAll("." + Y.texts)
                    .selectAll("." + Y.text)
                    .data(r),
                c = o
                    ...
                    .style("fill-opacity", 0);
            ((n.mainText = c.merge(o).text(function (t, e, i) {
        ...
        (m.redrawText = function (t, e, i, n, a) {
            return [
        ...
        (m.generateXYForText = function (t, e, i, n) {
            var a = this,
        ...
        (m.getTooltipContent = function (t, e, i, n) {
            var a,
                r,
                s,
                o,
            ...
            for (p && t.sort(p), r = 0; r < t.length; r++)
                if (
                    ...
                    void 0 !==
                        (o = _(
                            f(t[r].value, t[r].ratio, t[r].id, t[r].index, t),
                        )))
                ) {
                    if (null === t[r].name) continue;
                    ((c = _(g(t[r].name, t[r].ratio, t[r].id, t[r].index))),
                        (d = u.levelColor
                            ? u.levelColor(t[r].value)
                            : n(t[r].id)),
                        (a +=
                            "<tr class='" +
                            u.CLASS.tooltipName +
        ...
        (m.tooltipPosition = function (t, e, i, n) {
            var a,
                r,
                s,
                o,
        ...
        (m.showTooltip = function (t, e) {
            var i,
                ...
                d = s.tooltip_position || m.tooltipPosition;
            0 !== c.length &&
                s.tooltip_show &&
                (r.tooltip
                    .html(
                        s.tooltip_contents.call(
                            r,
                            t,
            ...
            return (
                (i.zoom = n
                    ...
                    .on("start", function () {
                        ...
                        (t && "brush" === t.type) ||
                            ((e = t), a.zoom_onzoomstart.call(i.api, t));
                    })
                    .on("zoom", function () {
                        var t = n.event.sourceEvent;
                        (t && "brush" === t.type) || i.redrawForZoom.call(i);
                    })
                    .on("end", function () {
                        var t = n.event.sourceEvent;
                        (t && "brush" === t.type) ||
                            (t &&
                                e.clientX === t.clientX &&
                                e.clientY === t.clientY) ||
                            a.zoom_onzoomend.call(i.api, i.x.orgDomain());
                    })),
