...
(function (t, n) {
                ...
                : function (t) {
                      return function () {
                          var n = this.ownerDocument,
                              e = this.namespaceURI;
                          return e === ds &&
                              n.documentElement.namespaceURI === ds
                              ? n.createElement(t)
    ...
    function Bt(t) {
        ...
        return (
            i === o && o === a
                ? (e = r = u)
                : ((e = jt(
                      (0.4360747 * i + 0.3850649 * o + 0.1430804 * a) / qs,
                  )),
                  (r = jt(
                      (0.0139322 * i + 0.0971045 * o + 0.7141733 * a) / Ys,
                  ))),
                    ...
                    if ((h = u[c]).name === e.name) {
                        ...
                        h.state === Ul
                            ? ((h.state = Ol),
                              ...
                              delete u[c])
                            : +c < n &&
                              ((h.state = Ol), h.timer.stop(), delete u[c]);
                    }
                if (
                    (Cn(function () {
                        e.state === Dl &&
    ...
    function ke(t) {
        function n(t, n) {
            ...
            var r,
                ...
                s = !1;
            for (
                t.charCodeAt(a - 1) === Bh && --a,
                    t.charCodeAt(a - 1) === Fh && --a;
                (r = e()) !== Oh;
            ) {
        ...
        function n(t) {
            function n(t) {
                ...
                switch (
                    (d &&
                        l &&
                        ((t = e(A + t, A.length ? h - x.length : 1 / 0)),
                        (A = "")),
                    f)
                ) {
                    case "<":
    ...
    function ur(t, n) {
        return Math.max(
            0,
            3 * Math.max(-8, Math.min(8, Math.floor(Ke(n) / 3))) -
                Ke(Math.abs(t)),
        );
    }
    function fr(t, n) {
        ...
        return function (a) {
            ...
            var s,
                ...
                A = {
                    ...
                    lineEnd: function () {
                        (s &&
                            (c(d, p), v && b && M.rejoin(), s.push(M.result())),
                            (A.point = f),
                            b && w.lineEnd());
                    },
                    polygonStart: function () {
    ...
    function Ta(t, n) {
        function e() {
            return (
                (i = Math.min(u.length, f.length) > 2 ? Ma : wa),
                (o = a = null),
                r
            );
        }
                        ...
                        case "r":
                            null != r.precision ||
                                isNaN(
                                    (i = fr(
                                        u,
                                        Math.max(Math.abs(o), Math.abs(a)),
                                    )),
                                ) ||
        ...
        return Ia(
            ...
            function (t, n) {
                return (
                    (n -
                        t -
                        (n.getTimezoneOffset() - t.getTimezoneOffset()) * Uv) /
                    qv
                );
            },
        );
        ...
        var i = t.dateTime,
            ...
            A = {
                a: function (t, n, e) {
                    ...
                    return r
                        ? ((t.w = y[r[0].toLowerCase()]), e + r[0].length)
                        : -1;
                },
                A: function (t, n, e) {
                    var r = p.exec(n.slice(e));
                    return r
                        ? ((t.w = v[r[0].toLowerCase()]), e + r[0].length)
                        : -1;
                },
                b: function (t, n, e) {
                    var r = m.exec(n.slice(e));
                    return r
                        ? ((t.m = x[r[0].toLowerCase()]), e + r[0].length)
                        : -1;
                },
                B: function (t, n, e) {
                    var r = _.exec(n.slice(e));
                    return r
                        ? ((t.m = b[r[0].toLowerCase()]), e + r[0].length)
                        : -1;
                },
                c: function (t, n, e) {
                    return r(t, i, n, e);
                ...
                p: function (t, n, e) {
                    ...
                    return r
                        ? ((t.p = d[r[0].toLowerCase()]), e + r[0].length)
                        : -1;
                },
                Q: gu,
                s: yu,
    ...
    function qf(t, n, e, r, i) {
        var o = Pf(n, e),
            ...
            f = Pf(r, i);
        (t.moveTo(o[0], o[1]),
            t.bezierCurveTo(a[0], a[1], u[0], u[1], f[0], f[1]));
    }
    function Of() {}
    function Yf(t, n, e) {
    ...
    function Yc(t, n) {
        var e,
            ...
            o = t.sort(Oc).pop();
        for (
            eb = [], tb = new Array(t.length), K_ = new yc(), nb = new yc();
            ;
        )
            if (
                ((i = J_),
            ...
            ((function (t, n, e, r) {
                ...
                (function (t, n, e, r) {
                    ...
                    for (i = 0; i < g; ++i)
                        if ((o = tb[i])) {
                            for (
                                a = o.site, u = (f = o.halfedges).length;
                                u--;
                            )
                                eb[f[u]] || f.splice(u, 1);
        ...
        selectAll: function (t) {
            ...
            for (
                ...
                for (var a, u = n[o], f = u.length, c = 0; c < f; ++c)
                    (a = u[c]) &&
                        (r.push(t.call(a, a.__data__, c, u)), i.push(a));
            return new ut(r, i);
        },
        filter: function (t) {
            ...
            for (
                ...
                for (
                    var o, a = n[i], u = a.length, f = (r[i] = []), c = 0;
                    c < u;
                    ++c
                )
    ...
    ((rd.copy = function () {
        ...
        (rd.visitAfter = function (t) {
            ...
            for (
                this._root &&
                e.push(
                    new Be(this._root, this._x0, this._y0, this._x1, this._y1),
                );
                (n = e.pop());
            ) {
                var i = n.node;
            ...
            s: function (t, n) {
                ...
                var r = e[0],
                    ...
                    o =
                        i -
                        (ud =
                            3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) +
                        1,
                    a = r.length;
                return o === a
                    ? r
    ...
    var yp,
        ...
        Bp = {
            ...
            polygonEnd: function () {
                ((Bp.lineStart = Bp.lineEnd = Bp.point = vr),
                    Op.add(Qd(Yp)),
                    Yp.reset());
            },
            result: function () {
            ...
            point: function (t, n) {
                ...
                if (((t = +t), (n = +n), t !== this._x1 || n !== this._y1)) {
                    switch (this._point) {
                        ...
                        case 2:
                            ((this._point = 3),
                                ec(this, nc(this, (e = tc(this, t, n))), e));
                            break;
                        default:
    ...
    ((Ic.prototype = Fc.prototype),
        ...
        (t.histogram = function () {
            ...
            return (
                ...
                (t.domain = function (n) {
                    return arguments.length
                        ? ((e = "function" == typeof n ? n : f([n[0], n[1]])),
                          t)
                        : e;
                }),
                (t.thresholds = function (n) {
        ...
        (t.thresholdScott = function (t, n, e) {
            return Math.ceil(
                (e - n) / (3.5 * a(t) * Math.pow(t.length, -1 / 3)),
            );
        }),
        ...
        (t.contourDensity = function () {
            function t(t) {
                ...
                if (!Array.isArray(i)) {
                    var o = g(e);
                    ((i = d(0, o, i)),
                        (i = s(0, Math.floor(o / i) * i, i)).shift());
                }
                return Me().thresholds(i).size([v, y])(e).map(n);
            }
            function n(t) {
                return (
                    (t.value *= Math.pow(2, -2 * h)),
            ...
            function i(t) {
                ((t[0] = t[0] * Math.pow(2, h) - p),
                    (t[1] = t[1] * Math.pow(2, h) - p));
            }
            function o() {
                return (
                    (p = 3 * l),
            ...
            return (
                ...
                (t.bandwidth = function (t) {
                    ...
                    return (
                        (l = Math.round((Math.sqrt(4 * t * t + 1) - 1) / 2)),
                        o()
                    );
                }),
                t
                    ...
                    for (n = 0, f = new Array(l); n < h; ++n)
                        (((e = t[n]).index = n),
                            "object" != typeof e.source &&
                                (e.source = We(d, e.source)),
                            "object" != typeof e.target &&
                                (e.target = We(d, e.target)),
        ...
        (t.geoCentroid = function (t) {
            ((Nd = Sd = Ed = kd = Cd = Pd = zd = Rd = Ld = Dd = Ud = 0),
                br(t, gp));
            var n = Ld,
                e = Dd,
                r = Ud,
        ...
        (t.geoCircle = function () {
            ...
            return (
                (t.center = function (n) {
                    return arguments.length
                        ? ((r =
                              "function" == typeof n ? n : Qr([+n[0], +n[1]])),
                          t)
                        : r;
                }),
                (t.radius = function (n) {
        ...
        (t.tree = function () {
            function t(t) {
                var f = (function (t) {
                    for (
                        var n, e, r, i, o, a = new ca(t, 0), u = [a];
                        (n = u.pop());
                    )
                        if ((r = n._.children))
                            for (
                                ...
                                (u.push((e = n.children[i] = new ca(r[i], i))),
                                    (e.parent = n));
        ...
        (t.pie = function () {
            function t(t) {
                var u,
                    ...
                    y = Math.min(
                        T_,
                        Math.max(-T_, o.apply(this, arguments) - g),
                    ),
        ...
        (t.stack = function () {
            function t(t) {
                ...
                for (o = 0; o < c; ++o) {
                    for (
                        var l, h = u[o], d = (s[o] = new Array(f)), p = 0;
                        p < f;
                        ++p
                    )
        ...
        (t.stackOffsetDiverging = function (t, n) {
            if ((u = t.length) > 1)
                for (
                    var e, r, i, o, a, u, f = 0, c = t[n[0]].length;
                    f < c;
                    ++f
                )
                    for (o = a = 0, e = 0; e < u; ++e)
                ...
                t.on("start.zoom", function () {
                    ...
                    .tween("zoom", function () {
                        var t = arguments,
                            ...
                            l = A(
                                c.invert(u).concat(f / c.k),
                                s.invert(u).concat(f / s.k),
                            );
                        return function (t) {
                            if (1 === t) t = s;
                            else {
                ...
                if (g.apply(this, arguments)) {
                    var t = a(this, arguments),
                        ...
                        i = Math.max(
                            ...
                            Math.min(
                                x[1],
                                n.k * Math.pow(2, b.apply(this, arguments)),
                            ),
                        ),
                        o = pt(this);
                    if (t.wheel)
                    ...
                    (Hc(),
                        ...
                        t.zoom(
                            "mouse",
                            _(r(e(n, i), t.mouse[0], t.mouse[1]), t.extent, w),
                        ));
                }
            }
            function c() {
