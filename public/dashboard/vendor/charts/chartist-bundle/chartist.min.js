...
!(function (a, b) {
    ...
    return (
        (function (a, b, c) {
            ...
            ((c.namespaces = {
                ...
                (c.getHighLow = function (a, b, d) {
                    ...
                    var f = {
                            high:
                                void 0 === b.high ? -Number.MAX_VALUE : +b.high,
                    ...
                    if (e && c.projectLength(a, 1, k) >= d) k.step = 1;
                        ...
                        for (;;) {
                            if (m && c.projectLength(a, k.step, k) <= d)
                                ...
                                if (
                                    m ||
                                    !(c.projectLength(a, k.step / 2, k) >= d)
                                )
                                    break;
            ...
            function i(a, b, d, e, f) {
                ((this.container = c.querySelector(a)),
                    ...
                    (this.supportsForeignObject =
                        c.Svg.isSupported("Extensibility")),
        ...
        (function (a, b, c) {
            ...
            function d(a, d, e, f, g) {
                (a instanceof Element
                    ...
                    : ((this._node = b.createElementNS(c.namespaces.svg, a)),
                      "svg" === a &&
                          this.attr({ "xmlns:ct": c.namespaces.ct })),
                    d && this.attr(d),
                    e && this.addClass(e),
                    f &&
                        (g && f._node.firstChild
                            ? f._node.insertBefore(
                                  this._node,
                                  f._node.firstChild,
                              )
            ...
            function p(a) {
                return (
                    this._node.parentNode.replaceChild(a._node, this._node),
                    a
                );
            }
            function q(a, b) {
        ...
        (function (a, b, c) {
            ...
            function r(a) {
                ...
                return (
                    (b.pos = this.pos),
                    (b.pathElements = this.pathElements
                        .slice()
                        .map(function (a) {
                            return c.extend({}, a);
                        })),
        ...
        (function (a, b, c) {
            ...
            function e(a) {
                return (
                    (this.axisLength *
                        (+c.getMultiValue(a, this.units.pos) -
                            this.bounds.min)) /
                    this.bounds.range
                );
            }
        ...
        (function (a, b, c) {
            ...
            function d(a, b, d, e) {
                ...
                ((this.divisor = e.divisor || 1),
                    ...
                    c.FixedScaleAxis["super"].constructor.call(
                        this,
                        a,
                        d,
                        this.ticks,
                ...
                ((d =
                    ...
                    b.raw.series.forEach(
                        function (f, g) {
                            ...
                            var m = {
                                    lineSmooth: c.getSeriesOption(
                                        f,
                                        a,
                                        "lineSmooth",
                                    ),
                                    showPoint: c.getSeriesOption(
                                        f,
                                        a,
                                        "showPoint",
                                    ),
                                    showLine: c.getSeriesOption(
                                        f,
                                        a,
                                        "showLine",
                                    ),
                                    showArea: c.getSeriesOption(
                                        f,
                                        a,
                                        "showArea",
                                    ),
                                    areaBase: c.getSeriesOption(
                                        f,
                                        a,
                                        "areaBase",
                                    ),
            ...
            function d(a) {
                ...
                (a.distributeSeries
                    ? ((b = c.normalizeData(
                      ...
                      (b.normalized.series = b.normalized.series.map(
                          function (a) {
                              return [a];
                          },
                      )))
