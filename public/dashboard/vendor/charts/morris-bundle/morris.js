    ...
    Morris.Grid = (function (_super) {
        ...
        Grid.prototype.setData = function (data, redraw) {
            ...
            if (this.options.events.length > 0) {
                ...
                this.xmax = Math.max(
                    this.xmax,
                    Math.max.apply(Math, flatEvents),
                );
                this.xmin = Math.min(
                    this.xmin,
                    Math.min.apply(Math, flatEvents),
                );
            }
                ...
                if (
                    ...
                    bottomOffsets = function () {
                        ...
                        for (
                            ...
                            _results.push(
                                this.measureText(this.data[i].label, angle)
                                    .height,
                            );
                        }
                        return _results;
        ...
        Grid.prototype.hasToShow = function (i) {
            return (
                this.options.shown === true || this.options.shown[i] === true
            );
        };
    ...
    Morris.Bar = (function (_super) {
            ...
            for (
                ...
                if (
                    ...
                    if (!this.options.horizontal) {
                        _results.push(
                            (prevLabelMargin =
                                startPos - this.options.xLabelMargin),
                        );
                    } else {
        ...
        Bar.prototype.hitTest = function (x, y) {
            ...
            return Math.min(
                this.data.length - 1,
                Math.floor(
                    (pos - this.xStart) / (this.xSize / this.data.length),
                ),
            );
        };
