...
$(function () {
    $(
        "#popupDatepickerfrom1, #popupDatepickerfrom1Modal, #popupDatepickerfrom2, #popupDatepickerfrom3, #popupDatepickerfrom4, #popupDatepickerfrom5",
    ).datepick({
        monthsToShow: 1,
        monthsToStep: 1,
    });
    $(
        "#popupDatepickerto1, #popupDatepickerto1Modal, #popupDatepickerto2, #popupDatepickerto3, #popupDatepickerto4, #popupDatepickerto5",
    ).datepick({
        monthsToShow: 1,
        monthsToStep: 1,
    });
